...
export default function WeatherCard({
    ...
    return (
        <SpotlightCard
            className={`glass-panel rounded-2xl p-6 w-full max-w-md text-center text-black dark:text-white text-legible mx-auto mb-4 transition-opacity ${pageVisible ? (fade ? 'opacity-0' : 'opacity-100') : 'opacity-0'
                }`}
